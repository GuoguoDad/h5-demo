...
.scroll-indicator {
  ...
  div {
    ...
    article {
      padding: 0 20px;
      background: linear-gradient(to top right, green 50%, #f0f0f0 50%) no-repeat;
      background-size: 100% calc(100% - 598px + 4px);
      > * {
        position: relative;
        z-index: 9;
      }
    ...
    <div className="scroll-indicator">
      <div>
        <article>
          ...
          <p>五是“独角兽”
            企业快速增长，国际行业地位再创新高。2019年互联网百强企业及下属企业涌现出蚂蚁金服、字节跳动、京东数科、满帮集团、优刻得、找钢网等25家独角兽企业，同比增长38.9%，业务涉及金融科技、智慧物流、电子商务、新文娱等领域。从全球公司市值排名情况看，2018年，全球互联网公司市值前三十强中互联网百强企业占10家，其中，腾讯集团和阿里巴巴稳居全球互联网公司市值前十强。</p>
